...
from sklearn.neighbors import KNeighborsClassifier # this is an example of using kNN classifier
...
def build_classifier(images, labels):
    ...
    classifier = KNeighborsClassifier(n_neighbors=3) #use KNN for this 
...
#    #make confusion matrix for assignment
